    ...
    <div>
      ...
      <main className="flex min-h-screen flex-col items-center bg-[#f4c7a1] px-4 py-10">
        ...
        <div className="w-full max-w-[1180px]">
          <h1 className="title-card mx-auto mb-8 max-w-[780px] ">
            {adurasCanticosItem.nome}
          </h1>
        </div>
        <div className="h-4" />

        <div className="grid w-full max-w-[1180px] gap-8 md:grid-cols-2 md:items-start md:justify-items-center">
          <div className="text-content mx-auto w-full max-w-[560px] text-justify">
